...
import com.example.standard.ui.theme.LaunchModesTheme

class SecondActivity : ComponentActivity() {

    private val TAG : String = this@SecondActivity::class.java.simpleName
        ...
        setContent {
            ...
            LaunchModesTheme {
                ...
                Column(
                    ...
                    Text(
                        text = "This is Second Activity of Standard Module",
                    ...
                    Button(
                        ...
                        Text(
                            text = "Click Here to Go C Activity",
                            style = TextStyle(
                                fontSize = 16.sp,
